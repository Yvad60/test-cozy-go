...
const HouseForm = ({ price, address }: any) => {
  ...
  const slides = [
    [
      <div className="flex flex-col gap-10" key={1}>
        <div className="bg-white flex flex-col gap-2.5 p-5 rounded shadow">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex justify-between">
              ...
              /> */}
              {/* <FloatingLabelInput
                className=" w-[18rem] flex flex-col gap-2.5"
                key="phone"
                id="phone"
                label="House number"
                schema={numberSchema}
  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-3">
        ...
        {currentSlide === slides.length - 1 && <Button label={"Submit"} className={""} />}
      </div>
    </form>
  );
};
